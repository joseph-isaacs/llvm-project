...
; CHECK-NEXT:    tbnz x11, #55, .LBB2_10
; CHECK-NEXT:  // %bb.6:
; CHECK-NEXT:    extr x10, x10, x11, #2
; CHECK-NEXT:    lsr x11, x10, #32
; CHECK-NEXT:  .LBB2_7: // %itofp-if-end26
...
; CHECK-NEXT:    movi d0, #0000000000000000
; CHECK-NEXT:    ret
; CHECK-NEXT:  .LBB2_9: // %itofp-if-else
; CHECK-NEXT:    movi v0.2d, #0000000000000000
