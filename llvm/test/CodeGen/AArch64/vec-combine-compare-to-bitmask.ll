...
; the stack under SelectionDAG: the old lowering bailed here and fell into the
; generic bitcast-through-memory legalization, leaving behind a dead frame.
...
; CHECK-SD:       ; %bb.0:
; CHECK-SD-NEXT:    cmeq.2d v1, v1, #0
; CHECK-SD-NEXT:    cmeq.2d v0, v0, #0
; CHECK-SD-NEXT:    adrp x8, lCPI23_0@PAGE
; CHECK-SD-NEXT:    uzp1.4s v0, v0, v1
; CHECK-SD-NEXT:    ldr q1, [x8, lCPI23_0@PAGEOFF]
; CHECK-SD-NEXT:    bic.16b v0, v1, v0
; CHECK-SD-NEXT:    addv.4s s0, v0
; CHECK-SD-NEXT:    fmov w0, s0
; CHECK-SD-NEXT:    ret
...
; CHECK-GI-NEXT:    sub sp, sp, #16
; CHECK-GI-NEXT:    .cfi_def_cfa_offset 16
; CHECK-GI-NEXT:    cmtst.2d v0, v0, v0
; CHECK-GI-NEXT:    cmtst.2d v1, v1, v1
; CHECK-GI-NEXT:    uzp1.4s v0, v0, v1
; CHECK-GI-NEXT:    mov.s w8, v0[1]
; CHECK-GI-NEXT:    mov.s w9, v0[2]
; CHECK-GI-NEXT:    fmov w11, s0
; CHECK-GI-NEXT:    mov.s w10, v0[3]
...
; CHECK-SD-NEXT:    cmeq.4s v1, v1, #0
; CHECK-SD-NEXT:    cmeq.4s v0, v0, #0
; CHECK-SD-NEXT:    adrp x8, lCPI24_0@PAGE
; CHECK-SD-NEXT:    uzp1.8h v0, v0, v1
; CHECK-SD-NEXT:    ldr q1, [x8, lCPI24_0@PAGEOFF]
; CHECK-SD-NEXT:    bic.16b v0, v1, v0
; CHECK-SD-NEXT:    addv.8h h0, v0
; CHECK-SD-NEXT:    fmov w0, s0
; CHECK-SD-NEXT:    ret
...
; CHECK-SD:       ; %bb.0:
; CHECK-SD-NEXT:    cmeq.2d v3, v3, #0
; CHECK-SD-NEXT:    cmeq.2d v2, v2, #0
; CHECK-SD-NEXT:    adrp x8, lCPI25_0@PAGE
; CHECK-SD-NEXT:    cmeq.2d v1, v1, #0
; CHECK-SD-NEXT:    cmeq.2d v0, v0, #0
; CHECK-SD-NEXT:    uzp1.4s v2, v2, v3
; CHECK-SD-NEXT:    uzp1.4s v0, v0, v1
; CHECK-SD-NEXT:    ldr q1, [x8, lCPI25_0@PAGEOFF]
; CHECK-SD-NEXT:    uzp1.8h v0, v0, v2
; CHECK-SD-NEXT:    bic.16b v0, v1, v0
; CHECK-SD-NEXT:    addv.8h h0, v0
; CHECK-SD-NEXT:    fmov w0, s0
; CHECK-SD-NEXT:    ret
...
; CHECK-GI-NEXT:    cmtst.2d v0, v0, v0
; CHECK-GI-NEXT:    cmtst.2d v1, v1, v1
; CHECK-GI-NEXT:    cmtst.2d v2, v2, v2
; CHECK-GI-NEXT:    cmtst.2d v3, v3, v3
; CHECK-GI-NEXT:    uzp1.4s v0, v0, v1
; CHECK-GI-NEXT:    uzp1.4s v1, v2, v3
; CHECK-GI-NEXT:    uzp1.8h v0, v0, v1
; CHECK-GI-NEXT:    xtn.8b v0, v0
; CHECK-GI-NEXT:    umov.b w8, v0[1]
; CHECK-GI-NEXT:    umov.b w9, v0[0]
...
; CHECK-SD:       ; %bb.0:
; CHECK-SD-NEXT:    cmeq.4s v3, v3, #0
; CHECK-SD-NEXT:    cmeq.4s v2, v2, #0
; CHECK-SD-NEXT:    adrp x8, lCPI26_0@PAGE
; CHECK-SD-NEXT:    cmeq.4s v1, v1, #0
; CHECK-SD-NEXT:    cmeq.4s v0, v0, #0
; CHECK-SD-NEXT:    uzp1.8h v2, v2, v3
; CHECK-SD-NEXT:    uzp1.8h v0, v0, v1
; CHECK-SD-NEXT:    ldr q1, [x8, lCPI26_0@PAGEOFF]
; CHECK-SD-NEXT:    uzp1.16b v0, v0, v2
; CHECK-SD-NEXT:    bic.16b v0, v1, v0
; CHECK-SD-NEXT:    addp.16b v0, v0, v0
; CHECK-SD-NEXT:    addp.16b v0, v0, v0
; CHECK-SD-NEXT:    addp.16b v0, v0, v0
...
; CHECK-GI-NEXT:    cmtst.4s v0, v0, v0
; CHECK-GI-NEXT:    cmtst.4s v1, v1, v1
; CHECK-GI-NEXT:    cmtst.4s v2, v2, v2
; CHECK-GI-NEXT:    cmtst.4s v3, v3, v3
; CHECK-GI-NEXT:    uzp1.8h v0, v0, v1
...
; CHECK-SD:       ; %bb.0:
; CHECK-SD-NEXT:    cmeq.2d v7, v7, #0
; CHECK-SD-NEXT:    cmeq.2d v6, v6, #0
; CHECK-SD-NEXT:    adrp x8, lCPI27_0@PAGE
; CHECK-SD-NEXT:    cmeq.2d v5, v5, #0
; CHECK-SD-NEXT:    cmeq.2d v4, v4, #0
; CHECK-SD-NEXT:    cmeq.2d v3, v3, #0
; CHECK-SD-NEXT:    cmeq.2d v2, v2, #0
; CHECK-SD-NEXT:    cmeq.2d v1, v1, #0
; CHECK-SD-NEXT:    cmeq.2d v0, v0, #0
; CHECK-SD-NEXT:    uzp1.4s v6, v6, v7
; CHECK-SD-NEXT:    uzp1.4s v4, v4, v5
; CHECK-SD-NEXT:    uzp1.4s v2, v2, v3
; CHECK-SD-NEXT:    uzp1.4s v0, v0, v1
; CHECK-SD-NEXT:    uzp1.8h v1, v4, v6
; CHECK-SD-NEXT:    uzp1.8h v0, v0, v2
; CHECK-SD-NEXT:    mvn.16b v1, v1
; CHECK-SD-NEXT:    mvn.16b v0, v0
; CHECK-SD-NEXT:    uzp1.16b v0, v0, v1
; CHECK-SD-NEXT:    ldr q1, [x8, lCPI27_0@PAGEOFF]
; CHECK-SD-NEXT:    shl.16b v0, v0, #7
; CHECK-SD-NEXT:    cmlt.16b v0, v0, #0
; CHECK-SD-NEXT:    and.16b v0, v0, v1
; CHECK-SD-NEXT:    addp.16b v0, v0, v0
...
; CHECK-GI-NEXT:    cmtst.2d v2, v2, v2
; CHECK-GI-NEXT:    cmtst.2d v3, v3, v3
; CHECK-GI-NEXT:    cmtst.2d v4, v4, v4
; CHECK-GI-NEXT:    cmtst.2d v5, v5, v5
; CHECK-GI-NEXT:    cmtst.2d v6, v6, v6
; CHECK-GI-NEXT:    cmtst.2d v7, v7, v7
; CHECK-GI-NEXT:    uzp1.4s v0, v0, v1
; CHECK-GI-NEXT:    uzp1.4s v1, v2, v3
; CHECK-GI-NEXT:    uzp1.4s v2, v4, v5
; CHECK-GI-NEXT:    uzp1.4s v3, v6, v7
; CHECK-GI-NEXT:    uzp1.8h v0, v0, v1
; CHECK-GI-NEXT:    uzp1.8h v1, v2, v3
; CHECK-GI-NEXT:    uzp1.16b v0, v0, v1
; CHECK-GI-NEXT:    umov.b w8, v0[1]
...
; CHECK-SD:       ; %bb.0:
; CHECK-SD-NEXT:    fcmeq.4s v1, v1, v3
; CHECK-SD-NEXT:    fcmeq.4s v0, v0, v2
; CHECK-SD-NEXT:    adrp x8, lCPI28_0@PAGE
; CHECK-SD-NEXT:    uzp1.8h v0, v0, v1
; CHECK-SD-NEXT:    ldr q1, [x8, lCPI28_0@PAGEOFF]
; CHECK-SD-NEXT:    and.16b v0, v0, v1
; CHECK-SD-NEXT:    addv.8h h0, v0
; CHECK-SD-NEXT:    fmov w0, s0
; CHECK-SD-NEXT:    ret
...
; CHECK-GI-NEXT:    sub sp, sp, #16
; CHECK-GI-NEXT:    .cfi_def_cfa_offset 16
; CHECK-GI-NEXT:    fcmeq.4s v0, v0, v2
; CHECK-GI-NEXT:    fcmeq.4s v1, v1, v3
; CHECK-GI-NEXT:    uzp1.8h v0, v0, v1
; CHECK-GI-NEXT:    xtn.8b v0, v0
; CHECK-GI-NEXT:    umov.b w8, v0[1]
; CHECK-GI-NEXT:    umov.b w9, v0[0]
...
; CHECK-SD-NEXT:    adrp x8, lCPI29_0@PAGE
; CHECK-SD-NEXT:    splice z0.s, p0, z0.s, z1.s
; CHECK-SD-NEXT:    ptrue p0.s
; CHECK-SD-NEXT:    ldr q1, [x8, lCPI29_0@PAGEOFF]
