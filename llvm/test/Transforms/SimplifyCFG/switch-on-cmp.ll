...
; RUN: opt < %s -passes=simplifycfg -simplifycfg-require-and-preserve-domtree=1 -verify-dom-info -verify-each -S | FileCheck %s
; RUN: opt < %s -passes=simplifycfg -simplifycfg-require-and-preserve-domtree=0 -verify-each -S | FileCheck %s
